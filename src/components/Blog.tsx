...
const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Today, THRYVIX has 20 clinics on a 30-day free trial in the Areekode area of Malappuram. The goal is simple: show each clinic their own data after 30 days. No-shows prevented. Time saved. Revenue recovered. Let the numbers do the selling.',
